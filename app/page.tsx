            ...
            <div className="space-y-8">
              <div>
                ...
                <h2 className="text-4xl md:text-6xl font-bold flex flex-col">
                  ...
                  <span className="inline-block text-white">{MAIN_TITLE_LINE2}</span>
                </h2>
              </div>
            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative bg-black/40 backdrop-blur-sm rounded-2xl border border-[#0c83fe]/30 p-8 overflow-hidden" style={{ boxShadow: '0 0 20px rgba(12, 131, 254, 0.2)' }}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              style={{
                boxShadow: '0 0 15px rgba(12, 131, 254, 0.2)'
              }}
            >
      ...
      <section className="relative py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-[#0c83fe]/20 to-[#0c83fe]/20 rounded-2xl blur-2xl" />
              <div className="relative bg-black/40 backdrop-blur-sm p-8 rounded-2xl border border-[#0c83fe]/30" style={{ boxShadow: '0 0 20px rgba(12, 131, 254, 0.25)' }}>
                <div className="absolute inset-0 bg-gradient-to-r from-[#0c83fe]/5 to-[#0c83fe]/10 opacity-50" />
